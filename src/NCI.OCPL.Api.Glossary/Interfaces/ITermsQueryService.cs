...
namespace NCI.OCPL.Api.Glossary
{
    ...
    public interface ITermsQueryService
    {
        ...
        Task<GlossaryTermResults> GetAll(string dictionary, AudienceType audience, string language, int size, int from, bool includeAdditionalInfo);
        ...
        /// <returns>A GlossaryTermResults object containing the desired records.</returns>
        /// </summary>
        Task<GlossaryTermResults> Search(string dictionary, AudienceType audience, string language, string query, MatchType matchType, int size, int from, bool includeAdditionalInfo);
        ...
        /// <returns>A GlossaryTermResults object containing the desired records.</returns>
        /// </summary>
        Task<GlossaryTermResults> Expand(string dictionary, AudienceType audience, string language, string expandCharacter, int size, int from, bool includeAdditionalInfo);
